...
The 18-cell run used AMD's official gfx1151 ROCm 7.14.0 tarball on Ryzen AI
...
−2.8%; the 2026-08-15 `np=16` baseline added later is +16.1% — see the scoped
result). DFlash acceptance

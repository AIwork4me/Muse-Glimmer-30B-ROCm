...
6. **This directory remains ROCm 7.2.1 evidence.** ROCm 7.14.0 has a separate,
   scoped 18-cell GGUF matrix; of the four `np=16` GGUF cells the 17gb baseline
   was measured on 2026-08-15 (with the corrected SSE-framing client) and three
   remain deferred.
...
18 of 21 planned cells (17 from the 2026-08-13 pass plus the `np=16` 17gb
baseline measured 2026-08-15 with the fixed SSE-framing client).
